clear;
% GT_Original_image_dir = 'C:\Users\csjunxu\Desktop\CVPR2018 Denoising\d1_Results\NoisyImage\';
% GT_fpath = fullfile(GT_Original_image_dir, '*.png');
% TT_Original_image_dir = 'C:\Users\csjunxu\Desktop\CVPR2018 Denoising\d1_Results\NoisyImage\';
...
for lambda = [50 100 500 1000 5000 10000]
    Par.lambda = lambda;
    % set Parameters
    ...
    for i = 1 : im_num
        ...
        %% output
        imname = sprintf([write_sRGB_dir 'SC_' dataset '_' num2str(lambda) '_' TT_im_dir(i).name]);
    ...
    mCCPSNR = mean(CCPSNR);
    mCCSSIM = mean(CCSSIM);
    save([write_MAT_dir 'SC_' dataset '_delta' num2str(Par.delta) '_ps' num2str(Par.ps) '_step' num2str(Par.step) '_nlspini' num2str(Par.nlspini) '_nlspgap' num2str(Par.nlspgap) '_l' num2str(Par.lambda) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
end
